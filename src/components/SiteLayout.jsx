...
export function SiteLayout({ children }) {
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(217,164,74,0.18),transparent_28%),radial-gradient(circle_at_top_right,rgba(97,124,167,0.16),transparent_30%),linear-gradient(180deg,#07101b_0%,#0b1625_52%,#08111d_100%)] text-stone-100">
      <header className="sticky top-0 z-30 border-b border-amber-300/15 bg-slate-950/75 backdrop-blur-xl">
        <nav className="mx-auto flex w-full max-w-7xl flex-col gap-4 px-4 py-4 md:flex-row md:items-center md:justify-between md:px-6">
          <NavLink to="/about" end className="flex items-center gap-4">
            <span className="grid h-12 w-12 place-items-center rounded-2xl bg-linear-to-br from-amber-200 to-amber-500 text-sm font-black tracking-[0.18em] text-slate-950 shadow-[0_16px_35px_rgba(217,164,74,0.3)]">
              SB
            </span>
            <span>
      ...
      <footer className="mx-auto w-full max-w-7xl px-4 pb-8 pt-4 md:px-6">
        <div className="grid gap-6 rounded-4xl border border-amber-300/15 bg-slate-950/80 p-6 shadow-[0_24px_70px_rgba(0,0,0,0.35)] md:grid-cols-3">
          <div>
